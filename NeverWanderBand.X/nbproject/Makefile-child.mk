...
MP_LINKER_FILE_OPTION=,--script="..\..\..\..\..\..\ece3724\pic24lib_all\lib\lkr\p33EP256GP502_bootldr.gld"
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/NeverWanderBand.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../../../../../../ece3724/pic24lib_all/lib/lkr/p33EP256GP502_bootldr.gld
